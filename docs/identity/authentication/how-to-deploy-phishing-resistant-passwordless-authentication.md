...
Within each persona there may be specifci role functions, which will have their own challenges and considerations. You can consider the table below, which contains specific guidance for particular roles within your organisation.
...
Microsoft recommends driving usage based on which user personas are most ready for deployment. Typically, this means deploying for Admins first, but this may change depending on your organizations needs.
